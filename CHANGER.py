...
with open('internal_ips.json') as f:
    data = json.load(f)

# Получаем IP-адрес модема №1 из данных файла internal_ips.json
internal_ip = data['Modem 1']['internal_ip']
...
url = "http://{}/api/api/webserver/SesTokInfo".format(internal_ip)
